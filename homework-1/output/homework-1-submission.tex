...
\begin{table}[H]
    \centering
    \input{./table/samplemeantable.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{figure/samplehist.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics{./figure/statadensity.pdf}
...
\begin{table}[H]
    \centering
    \input{./table/sampleoutput_stata.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{./figure/samplebars.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics{./figure/samplebars_stata.pdf}
    \caption{Regression coefficient estimates with 95\% confidence intervals bootstrapped using 1,000 replications.}
